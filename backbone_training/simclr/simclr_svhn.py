...
class SVHNPair(SVHN):
    """Generate mini-batche pairs on SVHN training set."""
...
def get_color_distortion(s=0.5):  # 0.5 for SVHN by default
...
def train(args: DictConfig) -> None:
    ...
    train_set = SVHNPair(root=data_dir,
                            split='train',
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch >= args.log_interval and epoch % args.log_interval == 0:
            ...
            torch.save(model.state_dict(), '{}.pth'.format(args.bn, epoch))
