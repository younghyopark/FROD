...
parser.add_argument('--ckpt_epoch',type=int,default=500)
...
#     l0 = open('./trained_autoencoders/vanilla_AE/'+opt.backbone_name+'/confidence_layer_{}_in_{}_epoch_{}_{}_train_{}.txt'.format(j,opt.dataset,epoch, opt.feature_extraction_type, opt.augmentation), 'w')
...
#     rc_error_ind_total_np = rc_error_ind_total.detach().cpu().numpy()  
#     ind_score = -rc_error_ind_total_np
#     l1 = open('./trained_autoencoders/vanilla_AE/'+opt.backbone_name+'/confidence_layer_{}_in_{}_epoch_{}_{}_{}.txt'.format(j,opt.dataset,epoch, opt.feature_extraction_type, opt.augmentation), 'w')
#     for i in range(ind_score.shape[0]):
#         l1.write("{}\n".format(ind_score[i]))
#     l1.close()
...
#         l2 = open('./trained_autoencoders/vanilla_AE/'+opt.backbone_name+'/confidence_layer_{}_out_{}_epoch_{}_{}_model1_{}.txt'.format(j,out_dataset[out_n],epoch, opt.feature_extraction_type, opt.augmentation), 'w')
